...
export FIRST_EIMIS_USERNAME="<username of the first user created when bootstraping>"
export FIRST_EIMIS_PASSWORD="<password of the first user created when bootstraping>"
export DUMMY_USERNAME="<dummy user used with the discovery room mecanism>"
export DUMMY_PASSWORD="<password for the dummy user>"
export FEDERATION_SERVERS_LIST="<list of comma separated URI of synapse servers included in federation. Ex : ['mx1.net','matrix2.fr']>"
...
export AM_MAIL_RECEIVER="<mail that receives alerts sent by mail : Ex: middle-run.fr@ploup.com>"
# stunner
